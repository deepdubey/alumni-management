    ...
    <form class="form" action="<?php echo htmlspecialchars('editAlumni.php?id='.$id)?>" method="post">
      ...
      <table>
        ...
        <tr id="radioBtn">
          <td colspan="2">
            <div class="rb">
              <h4>Working</h4><input type="radio" id="groupA" onchange="myFunction('working')" name="working" value="Yes" required>
            </div>
            <div class="rb">
              <h4>Not Working</h4><input type="radio" id="groupB" onchange="myFunction('not working')" name="working" value="No" required>
            </div>
          </td>
        </tr>
